if (!lexiconForJs) {
    var lexiconForJs = {
        ...
        "showed": "Shown",
        "currency": "$",
        "messageError": "An error occurred in the process",
        "requiredField": "This field must be filled in",
        "incorrectEmail": "Enter a valid email address",
        "incorrectPhone": "Enter the correct phone number",
...
function hideMenu() {
    ...
    window.innerWidth < 1024 && document.documentElement.scrollTop > 420 && e > lastScrollTop ? $("header").addClass("hide2") : $("header").removeClass("hide"),
        (lastScrollTop = e <= 0 ? 0 : e);
}
function scrollNav() {
    $(window).scrollTop() >= offserHeader ? ($("header").addClass("scroll"),
    window.innerWidth > 767 && $(".single-product-section__content").length > 0 && ($(window).scrollTop() >= $(".single-product-section__content").offset().top + $(".single-product-section__content").outerHeight(!0) - $("header").height() ? $(".product-bottom-panel").addClass("show") : $(".product-bottom-panel").removeClass("show"))) : ($("header").removeClass("scroll"),
    $(".general-swiper").length > 0 && window.innerWidth > 1023 && ((offsetTop = ($(window).scrollTop() / 10) * -1),
        $(".general-swiper").css({
    ...
    $(".single-photo.fixed").length > 0 && window.innerWidth > 1023 && ((offsetTop = ($(window).scrollTop() / 10) * -1),
...
function logoSwiperFunc() {
    window.innerWidth < 768 ? $(".partners-box > .swiper-container:first-child").length > 0 && (logoSwiper = new Swiper(".partners-box > .swiper-container:first-child",{
        speed: 300,
        allowTouchMove: !1,
        initialSlide: 3,
        ...
        on: {
            resize: function() {
                let e = this;
                e.update(),
                    window.innerWidth < 768 ? e.init() : e.destroy();
            },
        },
    })).init() : logoSwiper && logoSwiper.destroy();
}
            ...
            if ($(window).scrollTop() > $(i).offset().top - ($("header").height() + 100) && $(window).scrollTop() < $(i).offset().top + $(i).height()) {
                ...
                $(".delivery-switcher > *").removeClass("active"),
                    ...
                    $($(".delivery-switcher .scroll")).css({
                        top: $(".delivery-switcher > a[href=" + e + "]").position().top,
                        height: $(".delivery-switcher > a[href=" + e + "]").outerHeight()
                    });
            }
        });
    } catch (error) {}
...
function changeShowView() {
    window.innerWidth < 767 ? ($(".shop-format > [data-format='many']").removeClass("active"),
        $(".shop-format > [data-format='few']").addClass("active"),
        $(".shop-section__goods_content").addClass("few")) : ($(".shop-format > [data-format='few']").removeClass("active"),
        $(".shop-format > [data-format='many']").addClass("active"),
        $(".shop-section__goods_content").removeClass("few"));
}
...
$(document).ready(function() {
    ...
    function i(e, i, t, s) {
        i.closest(e).find("img[data-color=" + t + "]").is(":hidden") ? (i.closest(e).find(".slide-product__img_colors [data-color]").removeClass("active"),
            i.addClass("active"),
            i.closest(e).find("img[data-color]").fadeOut(200),
            setTimeout( () => {
                    i.closest(e).find("img[data-color=" + t + "]").fadeIn(200);
                }
                , 200),
            i.closest(e).find(".slide-product__information_head>span").html(s + " р.")) : (i.closest(e).find(".slide-product__img_colors [data-color]").removeClass("active"),
            i.addClass("active"));
    }
    ...
    $(".general-swiper").length > 0 ? ((offserHeader = $(".general-swiper").position().top + $(".general-swiper").height()),
    ...
    $(".about-us-swiper").length > 0 && (aboutUsSwiper = new Swiper(".about-us-swiper",{
        speed: 2000,
        spaceBetween: 0,
        slidesPerView: "auto",
        autoplay: {
    ...
    $(".experts-swiper").length > 0 && (expertSwiper = new Swiper(".experts-swiper",{
        speed: 2000,
        spaceBetween: 0,
        slidesPerView: "auto",
        autoplay: {
        ...
        navigation: {
            nextEl: ".experts-swiper-nav .swiper-button-next",
            prevEl: ".experts-swiper-nav .swiper-button-prev"
        },
        on: {
            init: function() {
                let i = this;
    ...
    $(".experts-swiper2").length > 0 && (expertSwiper = new Swiper(".experts-swiper2",{
        speed: 2000,
        spaceBetween: 0,
        slidesPerView: "auto",
        autoplay: {
        ...
        pagination: {
            el: ".experts-swipe2r-pagination",
            clickable: !0
        },
        navigation: {
            nextEl: ".experts-swiper2-nav .swiper-button-next",
            prevEl: ".experts-swiper2-nav .swiper-button-prev"
        },
        on: {
            init: function() {
                let i = this;
    ...
    $(".partners-swiper").length > 0 && (partnersSwiper = new Swiper(".partners-swiper",{
        speed: 300,
        allowTouchMove: !1,
        initialSlide: 1,
        centeredSlides: !0,
    ...
    $(".partners-swipernew").length > 0 && (partnersSwiperNew = new Swiper(".partners-swipernew",{
        speed: 300,
        allowTouchMove: !1,
        initialSlide: 1,
        centeredSlides: !0,
    ...
    $(".product-swiper").length > 0 && (productSwiper = new Swiper(".product-swiper",{
        speed: 400,
        loop: !1,
        grabCursor: !0,
        keyboard: {
    ...
    $(".collection-swiper").length > 0 && (collectionSwiper = new Swiper(".collection-swiper",{
        speed: 400,
        loop: !1,
        freeMode: !0,
        keyboard: {
    ...
    $(".reviews-swiper").length > 0 && (reviewsSwiper = new Swiper(".reviews-swiper",{
        speed: 500,
        loop: !0,
        keyboard: {
            enabled: !0,
    ...
    $(".pillow-slider").length > 0 && $(".pillow-slider .swiper-slide").length > 3 && (pillowSwiper = new Swiper(".pillow-slider",{
        speed: 300,
        direction: "vertical",
        loop: !0,
        slidesPerView: "auto",
    ...
    $(".goods-reviews").length > 0 && (goodsReviews = new Swiper(".goods-reviews .swiper-container",{
        speed: 2e3,
        loop: !0,
        autoplay: {
            delay: 5e3
    ...
    $(".patents-slider").length > 0 && (patents = new Swiper(".patents-slider .swiper-container",{
        speed: 300,
        loop: false,
        autoplay: false,
        spaceBetween: 40,
        ...
        slidesPerView: "auto",
        navigation: {
            nextEl: ".patents-slider .swiper-button-next",
            prevEl: ".patents-slider .swiper-button-prev"
        },
        breakpoints: {
            0: {
                centeredSlides: true
    ...
    $(".swiper-duo-swiper.first").length > 0 && (duoSwiperFirst = new Swiper(".swiper-duo-swiper.first",{
        speed: 1e3,
        spaceBetween: 30,
        loop: !0,
        keyboard: {
    ...
    $(".swiper-duo-swiper.second").length > 0 && (duoSwiperSecond = new Swiper(".swiper-duo-swiper.second",{
        speed: 1e3,
        spaceBetween: 30,
        loop: !0,
        keyboard: {
    ...
    $(".swiper-other-products.first").length > 0 && (swiperOtherProducts = new Swiper(".swiper-other-products.first",{
        loop: !0,
        speed: 1e3,
        spaceBetween: 47,
        navigation: {
    ...
    $(".partners-swipernew").length > 0 && (partnersSwiperNew = new Swiper(".partners-swipernew",{
        ...
        $(document).on("click", ".pp_", function(e) {
            ...
            var i = $(this)
                , s = i.attr("data-pp");
            if (i.attr("href") == "" || (typeof (i.attr("href")) == "undefined")) {} else {
                document.location.href = i.attr("href");
            }
            if (($("html,body").addClass("noscroll"),
                $(".pp").removeClass("show"),
                $('.pp[data-pp="' + s + '"]').addClass("show"),
            "promo-video" === s))
                t && t.play();
            else if ("video-review" == s)
                $('.pp[data-pp="' + s + '"] iframe').attr("src", urlToId(i.data("link")));
            else if ("video-expert" == s)
                $('.pp[data-pp="video-review"] iframe').attr("src", i.data("link"));
            else if ("certificate" === s)
                $('.pp[data-pp="' + s + '"] .popup-content img ').attr("src", i.data("link"));
                ...
                i.find(".reviews-reviewer__photo img").length > 0 ? (a = i.find(".reviews-reviewer__photo img")) : (l = i.find(".reviews-reviewer__photo span")),
                    ...
                    a ? ($('.pp[data-pp="' + s + '"] .reviews-text-item__photo > div').removeClass("nophoto"),
                        a.clone().appendTo('.pp[data-pp="' + s + '"] .reviews-text-item__photo > div')) : o && ($('.pp[data-pp="' + s + '"] .reviews-text-item__photo > div').addClass("nophoto"),
                        l.clone().appendTo('.pp[data-pp="' + s + '"] .reviews-text-item__photo > div'));
            }
        }),
        $(document).on("click", ".pp__close, .pp__bg, .close_btn", function() {
            ...
            "mailing-pop" === $(this).closest(".pp").data("pp") && setCookie("mailing-hide", !0, {
                expires: new Date(new Date().getTime() + 7 * 24 * 60 * 60 * 1000).toUTCString(),
                path: "/"
            }),
            "mailing-pop_second" === $(this).closest(".pp").data("pp") && setCookie("mailing_second-hide", !0, {
                expires: new Date(new Date().getTime() + 7 * 24 * 60 * 60 * 1000).toUTCString(),
                path: "/"
            });
        }),
        (document.onkeydown = function(e) {
                ...
                t && t.pause(),
                    ...
                    $('.pp[data-pp="fullreview"] .review-product ').empty(),
                    $('.pp[data-pp="fullreview"] .reviews-text-item__photo > div ').empty()),
                "mailing-pop" === $(".pp.show").data("pp") && setCookie("mailing-hide", !0, {
                    expires: new Date(new Date().getTime() + 7 * 24 * 60 * 60 * 1000).toUTCString(),
                    path: "/"
                }),
                "mailing-pop_second" === $(".pp.show").data("pp") && setCookie("mailing_second-hide", !0, {
                    expires: new Date(new Date().getTime() + 7 * 24 * 60 * 60 * 1000).toUTCString(),
                    path: "/"
                });
            }
            ...
            if (-1 !== i.attr("href").indexOf("#"))
                try {
                    let t = $(this).attr("href")
                        , s = $(t).offset().top;
                    return (i.parent("div").hasClass("delivery-switcher") && (i.hasClass("active") || ($(".delivery-switcher > *").removeClass("active"),
                        i.addClass("active"))),
                        $("html,body").animate({
                            scrollTop: s - $("header").height() - 20
                        }, 1e3),
                        !1);
                } catch (e) {}
        }),
        $(".partners-logo__item").hover(function(e) {
            let i = $(this)
                , t = i.data("num");
            i.hasClass("acitve") || ($(".partners-logo__item").removeClass("active"),
                i.addClass("active"),
            partnersSwiper && partnersSwiper.slideTo(parseInt(t)));
        }, function(e) {}),
        $(document).on("touchstart, click", function(e) {
            if (window.innerWidth < 1024 && $(".header-common__bottom").hasClass("active")) {
                var i = $(".header-common");
                i.is(e.target) || 0 !== i.has(e.target).length || ($(".burger-menu").removeClass("active"),
                    $(".header-common__bottom").removeClass("active"),
                    $("html,body").removeClass("noscroll"));
            }
        }),
        $(document).on("touchstart, click", ".burger-menu", function(e) {
            window.innerWidth < 1024 && ($(this).toggleClass("active"),
                $(".header-common__bottom").toggleClass("active"),
                $("html,body").toggleClass("noscroll"));
        }),
        $(document).on("touchstart, click", ".header-menu__item", function(e) {
            window.innerWidth < 1024 && ($(this).hasClass("hover") ? ($(this).removeClass("hover"),
                $(this).find(".header-menu__item_content").slideUp(300)) : ($(".header-menu__item").removeClass("hover"),
        ...
        $(".menu-container > div").on("touchstart, click", function(e) {
            Math.min(window.innerWidth, window.innerWidth) < 1024 && ($(this).hasClass("hover") ? ($(this).removeClass("hover"),
                $(this).find("ul").slideUp(300)) : ($(".menu-container > div").removeClass("hover"),
                $(".menu-container > div").find("ul").slideUp(300),
                $(this).addClass("hover"),
                $(this).find("ul").slideDown(300)));
        }),
        $(document).on("touchstart, click", ".slide-product__img_colors [data-color]", function(e) {
            let t, s = $(this), o = $(this).data("color"), r = $(this).data("price");
            s.closest(".adds-item").length > 0 ? i((t = s.closest(".adds-item")), s, o, r) : s.closest(".swiper-slide").length > 0 ? i((t = s.closest(".swiper-slide")), s, o, r) : s.closest(".product-other").length > 0 ? ($(".single-product-hints .slide-product__img_colors [data-color=" + o + "]").trigger("click"),
                s.siblings("[data-color]").removeClass("active"),
                s.addClass("active")) : s.closest(".slide-product__img").find("img[data-color=" + o + "]").is(":hidden") ? (s.closest(".slide-product__img_colors").find("[data-color]").removeClass("active"),
                s.addClass("active"),
                s.closest(".slide-product__img").find("img[data-color]").fadeOut(200),
                setTimeout( () => {
                        s.closest(".slide-product__img").find("img[data-color=" + o + "]").fadeIn(200);
                    }
                    , 200),
                s.closest(".slide-product").find(".slide-product__info > span").html(r + " р."),
                s.closest(".adds-item").find(".slide-product__information_head>span").html(r + " р.")) : (s.closest(".slide-product__img_colors").find("[data-color]").removeClass("active"),
                s.addClass("active")),
            s.closest(".single-product-hints").length > 0 && ($(".product-other [data-color]").removeClass("active"),
                $(".product-other [data-color=" + o + "]").addClass("active"));
        }),
        $(document).on("touchstart, click", ".shop-format [data-format]", function(e) {
            let i = $(this)
                , t = i.data("format")
                , s = i.closest(".shop-section").find(".shop-section__goods_content");
            i.hasClass("active") || ($(".shop-format [data-format]").removeClass("active"),
                $(".shop-format [data-format=" + t + "]").addClass("active"),
                s.removeClass("many"),
                s.removeClass("few"),
                s.addClass(t));
        }),
        $(document).on("touchstart, click", ".faq__content_item", function(e) {
            ...
            i.hasClass("active") ? (i.removeClass("active"),
                i.find(".faq-answer").slideUp(300)) : ($(".faq__content_item").removeClass("active"),
        ...
        $(document).on("touchstart, click", ".pillow-slider .swiper-slide", function(e) {
            ...
            i.hasClass("active") || ($(".pillow-preview").removeClass("video"),
                $(".pillow-preview iframe").remove(),
                $(".pillow-slider .swiper-slide").removeClass("active"),
                i.addClass("active"),
            s && (window.innerWidth < 768 ? (i.removeClass("video"),
                i.find("ifame").remove(),
                i.addClass("video"),
        ...
        $(document).on("click", ".single-product__counter > .hand_button", function(e) {
            ...
            i.hasClass("increment") ? "" === t.val() ? t.val(1) : t.val() < 999 && t.val(parseInt(t.val()) + 1) : i.closest(".shopping-cart").length > 0 || i.closest(".cart-container__cart").length > 0 ? parseInt(t.val()) > 0 && t.val(parseInt(t.val()) - 1) : parseInt(t.val()) > 1 && t.val(parseInt(t.val()) - 1),
        ...
        $(document).on("click", ".input-row > .reviews-stars svg", function(e) {
            let i = $(this);
            switch ((i.parent(".reviews-stars").removeClass("one two three four five").addClass("clicked"),
                i.index())) {
                case 0:
                    i.parent(".reviews-stars").addClass("one"),
                        i.parent(".reviews-stars").find("input").val(i.index() + 1);
                    break;
                case 1:
    ...
    scrollNav(),
        hideMenu(),
    $.validator && ($.validator.addMethod("phoneUS", function(e, i) {
        return (e = e.replace(/\s+/g, "")),
        this.optional(i) || (e.length >= 9 && e.match(/^\s*\+?([- _():=+]?\d[- _():=+]?){9,14}\s*$/));
    }),
        $(".pp__content_question form").validate({
            ...
            messages: {
                email: {
                    required: lexiconForJs.requiredField,
                    email: lexiconForJs.incorrectEmail
                },
                phone: {
                    phoneUS: lexiconForJs.incorrectPhone
                },
                question: {
                    required: lexiconForJs.requiredField
                }
        ...
        $("form").submit(function(e) {
            ...
            i.hasClass("ignore") && i.trigger("submit"),
                !1 === i.valid() ? e.preventDefault() : (e.preventDefault(),
    ...
    $(".structure-section").length > 0 && $(window).width() > 1279 && (skr = skrollr.init()),
        $(document).on("change", ".input__group .checkbox input", function() {
            $(this).closest(".input__group").find(".checkbox").removeClass("checked");
    ...
    if (getCookie("geoIpApi")) {
        ...
        if (!getCookie("mailing_second-hide")) {
            setTimeout( () => {
                    if (!$(".pp_country[data-pp=mailing-pop_latcountry]").hasClass("show")) {
                        $(".pp[data-pp=mailing-pop_second]").addClass("show"),
                            $("html,body").addClass("noscroll");
                    }
                }
                , 100e3)
    ...
    $(window).resize(function() {
        ...
        swiperOtherProducts && swiperOtherProducts.update(),
            ...
            changeShowView();
        try {
            $(".structure-section").length > 0 && ($(window).width() <= 1279 ? ((skr = skrollr().destroy()),
                (skr = fasle)) : !1 === skr && (skr = skrollr.init()));
        } catch (e) {}
        hideMenu();
    }),
